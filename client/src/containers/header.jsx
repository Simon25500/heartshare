...
class Header extends Component {
    ...
    style = " shadow appearance-none border rounded-full  py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline "

    render(){
        return( 
          <div>
            <div className="pt-5 px-10 flex justify-around items-center">
                <Link to="/">
